...
export const API_ENDPOINTS = {
  ...
  PRODUCTS_CREATE: () => `${getApiBaseUrl()}/api/products`,
  PRODUCTS_GET: (id) => `${getApiBaseUrl()}/api/products/${id}`,
  PRODUCTS_UPDATE: (id) => `${getApiBaseUrl()}/api/products/${id}`,
  PRODUCTS_DELETE: (id) => `${getApiBaseUrl()}/api/products/${id}`,
  PRODUCTS_MY: (supplierId) => `${getApiBaseUrl()}/api/products?supplierId=${supplierId}`,
  ...
  // Upload endpoints
  UPLOAD_FILE: () => `${getApiBaseUrl()}/api/upload`,
  DELETE_FILE: () => `${getApiBaseUrl()}/api/upload`,
