  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const productData = {
        ...formData,
        supplierId: user._id,
        supplierName: user.companyName || user.company_name,
        ...
        primaryImage: formData.displayImage?.url || (formData.images.length > 0 ? formData.images[0].url : null),
        shipping: {
                ...
                <div className="space-y-4">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      disabled={uploadingDisplayImage || formData.displayImage}
                    ...
                    >
                      ...
                      {uploadingDisplayImage ? 'Uploading...' : formData.displayImage ? 'Display Image Added' : 'Upload Display Image'}
                    </button>
                      ...
                      {formData.images.map((image, index) => (
                        <div key={index} className="relative group border rounded-lg overflow-hidden">
                          {image.resourceType === 'video' ? (
                            ...
                            <img src={image.url} alt={`Product ${index + 1}`} className="w-full h-32 object-cover" />
                          )}
                          <button
                            type="button"
