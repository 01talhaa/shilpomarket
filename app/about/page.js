          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
              <div className="relative mb-6">
                <div class="w-44 h-44 rounded-full mx-auto shadow-lg group-hover:shadow-xl transition-shadow duration-300 overflow-hidden border-4 border-blue-100">
  <img src="/abs.jpeg" alt="A B S Talha - CEO" class="w-full object-cover h-56"/>
</div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
              ...
              <div className="relative mb-6">
                <div class="w-44 h-44 rounded-full mx-auto shadow-lg group-hover:shadow-xl transition-shadow duration-300 overflow-hidden border-4 border-blue-100">
  <img src="/shi.jpg" alt="Shihab Ahmed - CMO" class="w-full object-cover h-full"/>
</div>
              </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
              ...
              <div className="relative mb-6">
                <div class="w-44 h-44 rounded-full mx-auto shadow-lg group-hover:shadow-xl transition-shadow duration-300 overflow-hidden border-4 border-blue-100">
  <img src="/millu.jpg" alt="Ali Miladun - CFO" class="w-full object-cover h-56"/>
</div>
              </div>
              </div>
